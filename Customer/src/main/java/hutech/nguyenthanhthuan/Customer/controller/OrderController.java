...
import hutech.nguyenthanhthuan.Library.service.*;
...
public class OrderController {
    ...
    public String checkOut(Principal principal, Model model) {
        if (principal == null) {
            ...
            if (customer.getAddress() == null || customer.getCity() == null || customer.getPhoneNumber() == null) {
                model.addAttribute("information", "Bạn cần cập nhật thông tin của mình trước khi thanh toán");
                ...
                model.addAttribute("customer", customer);
                model.addAttribute("title", "Thủ tục thanh toán");
                model.addAttribute("page", "Thủ tục thanh toán");
    ...
    public String createOrder(Principal principal,
        ...
        if (principal == null) {
            ...
            model.addAttribute("page", "Chi tiết đặt hàng");
